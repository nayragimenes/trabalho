...
export class UsuarioCadastroComponent implements OnInit {
  ...
  inicializaFormulario() {
    this.usuarioForm = this.formBuilder.group({
      ...
      email:      [this.usuario?.email ? this.usuario.email : '', [Validators.required, Validators.maxLength(250)]],
      nascimento: [this.usuario?.nascimento ? this.usuario.nascimento : '1970-01-01',Validators.required],
  ...
  saveUsuario(usuario: UsuarioInterface): void {
